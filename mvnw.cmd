...
set "MAVEN_HOME=%MAVEN_PROJECTBASEDIR%.mvn\wrapper\apache-maven-3.9.8"

if not exist "%MAVEN_HOME%\bin\mvn.cmd" (
  echo Downloading Maven distribution...
  powershell -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri 'https://archive.apache.org/dist/maven/maven-3/3.9.8/binaries/apache-maven-3.9.8-bin.zip' -OutFile '%MAVEN_PROJECTBASEDIR%.mvn\wrapper\maven.zip' -UseBasicParsing"
